...
public final class ReservationServerClientHandler implements Runnable {
    ...
    public void run() {
        ...
        try {
            ...
            while (true) {
                ...
                print("Server sent:" + responseMessage + " Number of reservations:" +
                        responseMessage.getReservationList().size() + "\n");
                out.writeObject(responseMessage);
                out.flush();
                out.reset();
                requestMessage = null;
    ...
    private void setResponse(RequestMessage requestMessage, ResponseMessage responseMessage) throws IOException {
        ...
        if (requestMessage.getRequestType().equals(RequestType.ADDPASSENGER)) {
            ...
            ReservationServer.reservationModel.add(new Reservation(requestMessage.getPassenger(),
                    requestMessage.getAirLine()));
    ...
    private Gate getGate(Flight flight1) {
        return GateHandler.getGate(flight1);
    }
}