...
public class Flight {
    ...
    public void deletePassenger(Passenger passenger) throws FlightException {
        if (passengerList != null && passengerList.size() > 0) {
            ...
            throw new FlightException("Flight is empty.Can not remove passenger=" + passenger.getFirstName()
    ...
    public boolean equals(Object obj) {
        ...
        if (isFull != other.isFull)
            return false;
        return passengerCount == other.passengerCount;
    }

    @Override
    public String toString() {
        return "Flight [airLineName=" + airLineName + " flightNumber=" + flightNumber + ", passengerList="
                + passengerList + ", capacity=" + capacity +
