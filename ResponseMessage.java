...
public class ResponseMessage implements Serializable {
    ...
    public String toString() {
        return "ResponseMessage [requestType=" + requestType + ", message=" + message + ", airLineList=" +
                airLineList + ", reservationList=" + reservationList + " " + ", airLine=" + airLine + ", " +
                "flightNumber=" +
                flightNumber + ", flightCapacity=" + flightCapacity + ", gateNumber=" + gateNumber + ", passenger="
                + passenger +
                ", clientId=" + clientId + "]";
    }
}